      ...
      >
        <div className="p-8 rounded-2xl bg-white dark:bg-surface-card-dark border border-gray-100 dark:border-gray-800 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Join thousands of hustlers earning with AI</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <input
                  ...
                  {...register('password', {
                    ...
                    validate: {
                      ...
                      hasSpecial: (value) => /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(value) || 'Must include at least one special character (!@#$%^&*...)',
                    },
                  })}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-semibold text-white rounded-xl gradient-bg-accent hover:opacity-90 transition-all shadow-lg shadow-primary-500/25 disabled:opacity-50 mt-2"
            >
              {isLoading ? (
